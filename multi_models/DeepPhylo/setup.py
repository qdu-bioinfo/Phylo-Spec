...
if __name__ == '__main__':
    ...
    with open('deepphylo/__version__.py') as fh:
    ...
    setup(
        ...
        description='A phylogenetic information based enhanced Machine Learning prediction method.',
        ...
        keywords=['microbiome', 'nlp', 'deep learning', 'phylogeny'],
        python_requires='>=3.7',
        url='https://github.com/CNwangbin/DeepPhylo.git',
    )